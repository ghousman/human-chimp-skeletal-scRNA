...
saveRDS(fit, file=paste0("../data/gom-data/topics",clustnum,".human.data.filterC.log.indv-cell.intNo0.reg-",data.source,".rds"))
...
#Fit fastTopics model and save data
fit <- fit_poisson_nmf(counts, k=clustnum, numiter=100)
saveRDS(fit, file=paste0("../data/gom-data/topics",clustnum,".chimp.data.filterC.log.indv-cell.intNo0.reg-",data.source,".rds"))
