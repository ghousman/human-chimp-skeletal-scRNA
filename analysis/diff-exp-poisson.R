...
compare.ips  <- FindMarkers(subset(indv,subset=Cell.Type=="iPSC"),
                            ...
                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.ips, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.ips.rds"))
compare.msc  <- FindMarkers(subset(indv,subset=Cell.Type=="MSC"),
                            assay="RNA", slot="counts",
                            ident.1="Human", ident.2="Chimp",
                            logfc.threshold=0.25, min.pct=0.25,
                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.msc, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.msc.rds"))
compare.ost  <- FindMarkers(subset(indv,subset=Cell.Type=="Osteoblast"),
                            assay="RNA", slot="counts",
                            ident.1="Human", ident.2="Chimp",
                            logfc.threshold=0.25, min.pct=0.25,
                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.ost, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.ost.rds"))
...
compare.i  <- FindMarkers(subset(indv,subset=(seurat_clusters==1|seurat_clusters==4|seurat_clusters==6)),
                          ...
                          logfc.threshold=0.25, min.pct=0.25,
                          test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.i, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.i.rds"))
compare.m  <- FindMarkers(subset(indv,subset=seurat_clusters==0),
                          assay="RNA", slot="counts",
                          ident.1="Human", ident.2="Chimp",
                          logfc.threshold=0.25, min.pct=0.25,
                          test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.m, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.m.rds"))
compare.o  <- FindMarkers(subset(indv,subset=(seurat_clusters==2|seurat_clusters==3|seurat_clusters==5)),
                          assay="RNA", slot="counts",
                          ident.1="Human", ident.2="Chimp",
                          logfc.threshold=0.25, min.pct=0.25,
                          test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.o, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.o.rds"))
...
compare.i1  <- FindMarkers(subset(indv,subset=seurat_clusters==1),
                           ...
                           logfc.threshold=0.25, min.pct=0.25,
                           test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.i1, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.i1.rds"))
compare.i2  <- FindMarkers(subset(indv,subset=seurat_clusters==4),
                           assay="RNA", slot="counts",
                           ident.1="Human", ident.2="Chimp",
                           logfc.threshold=0.25, min.pct=0.25,
                           test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.i2, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.i2.rds"))
compare.i3  <- FindMarkers(subset(indv,subset=seurat_clusters==6),
                           assay="RNA", slot="counts",
                           ident.1="Human", ident.2="Chimp",
                           logfc.threshold=0.25, min.pct=0.25,
                           test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.i3, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.i3.rds"))
...
compare.o1  <- FindMarkers(subset(indv,subset=seurat_clusters==2),
                           ...
                           logfc.threshold=0.25, min.pct=0.25,
                           test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.o1, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.o1.rds"))
compare.o2  <- FindMarkers(subset(indv,subset=seurat_clusters==3),
                           assay="RNA", slot="counts",
                           ident.1="Human", ident.2="Chimp",
                           logfc.threshold=0.25, min.pct=0.25,
                           test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.o2, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.o2.rds"))
compare.o3  <- FindMarkers(subset(indv,subset=seurat_clusters==5),
                           assay="RNA", slot="counts",
                           ident.1="Human", ident.2="Chimp",
                           logfc.threshold=0.25, min.pct=0.25,
                           test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.o3, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.o3.rds"))
...
compare.hoci  <- FindMarkers(subset(indv,subset=AdHoc.Assign=="iPSC"),
                             ...
                             logfc.threshold=0.25, min.pct=0.25,
                             test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.hoci, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.hoci.rds"))
compare.hocm  <- FindMarkers(subset(indv,subset=AdHoc.Assign=="MSC"),
                             assay="RNA", slot="counts",
                             ident.1="Human", ident.2="Chimp",
                             logfc.threshold=0.25, min.pct=0.25,
                             test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.hocm, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.hocm.rds"))
compare.hoco  <- FindMarkers(subset(indv,subset=AdHoc.Assign=="Osteoblast"),
                             assay="RNA", slot="counts",
                             ident.1="Human", ident.2="Chimp",
                             logfc.threshold=0.25, min.pct=0.25,
                             test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.hoco, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.hoco.rds"))
...
compare.pre  <- FindMarkers(subset(indv,subset=OstAdHoc.Assign=="preosteoblast"),
                            ...
                            logfc.threshold=0.25, min.pct=0.25,
                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.pre, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.pre.rds"))
compare.obl  <- FindMarkers(subset(indv,subset=OstAdHoc.Assign=="osteoblast"),
                            assay="RNA", slot="counts",
                            ident.1="Human", ident.2="Chimp",
                            logfc.threshold=0.25, min.pct=0.25,
                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.obl, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.obl.rds"))
compare.emb  <- FindMarkers(subset(indv,subset=OstAdHoc.Assign=="embedding osteoblast"),
                            assay="RNA", slot="counts",
                            ident.1="Human", ident.2="Chimp",
                            logfc.threshold=0.25, min.pct=0.25,
                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.emb, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.emb.rds"))
#compare.min  <- FindMarkers(subset(indv,subset=OstAdHoc.Assign=="mineralizing osteocyte"),
#                            assay="RNA", slot="counts",
#                            ident.1="Human", ident.2="Chimp",
#                            logfc.threshold=0.25, min.pct=0.25,
#                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
#saveRDS(compare.min, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.min.rds"))
#compare.mat  <- FindMarkers(subset(indv,subset=OstAdHoc.Assign=="mature osteocyte"),
#                            assay="RNA", slot="counts",
#                            ident.1="Human", ident.2="Chimp",
#                            logfc.threshold=0.25, min.pct=0.25,
#                            test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
#saveRDS(compare.mat, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.mat.rds"))
...
compare.gomi  <- FindMarkers(subset(indv,subset=GoM.Assign=="iPSC"),
                             ...
                             logfc.threshold=0.25, min.pct=0.25,
                             test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.gomi, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.gomi.rds"))
compare.gomm  <- FindMarkers(subset(indv,subset=GoM.Assign=="MSC"),
                             assay="RNA", slot="counts",
                             ident.1="Human", ident.2="Chimp",
                             logfc.threshold=0.25, min.pct=0.25,
                             test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.gomm, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.gomm.rds"))
compare.gomo  <- FindMarkers(subset(indv,subset=GoM.Assign=="Osteoblast"),
                             assay="RNA", slot="counts",
                             ident.1="Human", ident.2="Chimp",
                             logfc.threshold=0.25, min.pct=0.25,
                             test.use="poisson", latent.vars=c("Collection","nCount_RNA","Phase"))
saveRDS(compare.gomo, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/de.p-compare.gomo.rds"))
