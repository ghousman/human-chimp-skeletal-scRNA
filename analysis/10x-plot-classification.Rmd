...
#umap
DimPlot(data,
        group.by="Cluster0.75",
        reduction="umap",
        cols=c("pink","palevioletred1","palevioletred3","palevioletred4",
               "pink3","pink4","grey40","grey",
               "mediumorchid","orchid2","orchid4","purple",
               "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
               "lightblue1","royalblue3","grey","black")) +
  labs(x="UMAP1",y="UMAP2")
DimPlot(data,
        group.by="Cluster0.75",
        split.by="Species",
...
#cell counts
ggplot(data@meta.data, aes(x=Cluster0.75, fill=Cluster0.75)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("pink","palevioletred1","palevioletred3","palevioletred4",
                                      "pink3","pink4","grey40","grey",
...
#umi counts
ggplot(data@meta.data, aes(x=Cluster0.75, y=nCount_RNA, fill=Cluster0.75)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("pink","palevioletred1","palevioletred3","palevioletred4",
                                      "pink3","pink4","grey40","grey",
...
#gene counts
ggplot(data@meta.data, aes(x=Cluster0.75, y=nFeature_RNA, fill=Cluster0.75)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("pink","palevioletred1","palevioletred3","palevioletred4",
                                      "pink3","pink4","grey40","grey",
...
#umap
DimPlot(data,
        group.by="OstCluster0.05",
        reduction="umap",
        cols=c("grey99","dodgerblue","navyblue")) +
  labs(x="UMAP1",y="UMAP2")
DimPlot(data,
        group.by="OstCluster0.05",
        split.by="Species",
...
#cell counts
ggplot(data@meta.data, aes(x=OstCluster0.05, fill=OstCluster0.05)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","navyblue")) +
  facet_grid(~Species)+
  theme_classic() +
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12),
        ...
        strip.text.x=element_text(size=12),
        axis.text.x=element_text(angle=90))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.05, fill=OstCluster0.05)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","navyblue")) +
  facet_grid(~Species)+
...
#umi counts
ggplot(data@meta.data, aes(x=OstCluster0.05, y=nCount_RNA, fill=OstCluster0.05)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","navyblue")) +
  facet_grid(~Species)+
  ...
  theme(axis.text=element_text(size=12),
        ...
        strip.text.x=element_text(size=12),
        axis.text.x=element_text(angle=90))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.05, y=nCount_RNA, fill=OstCluster0.05)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","navyblue")) +
  facet_grid(~Species)+
...
#gene counts
ggplot(data@meta.data, aes(x=OstCluster0.05, y=nFeature_RNA, fill=OstCluster0.05)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","navyblue")) +
  facet_grid(~Species)+
  ...
  theme(axis.text=element_text(size=12),
        ...
        strip.text.x=element_text(size=12),
        axis.text.x=element_text(angle=90))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.05, y=nFeature_RNA, fill=OstCluster0.05)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","navyblue")) +
  facet_grid(~Species)+
...
DotPlot(subset(data,subset=Species=="Human"),
        features=c("COL1A1","CD44","POU5F1"),
        group.by="OstCluster0.05", dot.scale=20,
        cols=c("grey99","black"),
        col.max=5)
DotPlot(subset(data,subset=Species=="Chimp"),
        features=c("COL1A1","CD44","POU5F1"),
...
#umap
DimPlot(data,
        group.by="OstCluster0.25",
        reduction="umap",
        cols=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  labs(x="UMAP1",y="UMAP2")
DimPlot(data,
        group.by="OstCluster0.25",
        split.by="Species",
...
#cell counts
ggplot(data@meta.data, aes(x=OstCluster0.25, fill=OstCluster0.25)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  theme_classic() +
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12),
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.25, fill=OstCluster0.25)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
...
#umi counts
ggplot(data@meta.data, aes(x=OstCluster0.25, y=nCount_RNA, fill=OstCluster0.25)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  ...
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.25, y=nCount_RNA, fill=OstCluster0.25)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
...
#gene counts
ggplot(data@meta.data, aes(x=OstCluster0.25, y=nFeature_RNA, fill=OstCluster0.25)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  ...
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.25, y=nFeature_RNA, fill=OstCluster0.25)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
...
DotPlot(subset(data,subset=Species=="Human"),
        features=c("COL1A1","CD44","POU5F1"),
        group.by="OstCluster0.25", dot.scale=20,
        cols=c("grey99","black"),
        col.max=5)
DotPlot(subset(data,subset=Species=="Chimp"),
        features=c("COL1A1","CD44","POU5F1"),
...
#umap
DimPlot(data,
        group.by="OstCluster0.50",
        reduction="umap",
        cols=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  labs(x="UMAP1",y="UMAP2")
DimPlot(data,
        group.by="OstCluster0.50",
        split.by="Species",
...
#cell counts
ggplot(data@meta.data, aes(x=OstCluster0.50, fill=OstCluster0.50)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  theme_classic() +
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12),
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$OstCluster0.50!="not osteogenic"),], aes(x=OstCluster0.50, fill=OstCluster0.50)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  theme_classic() +
  theme(axis.text=element_text(size=12),
        axis.title=element_text(size=12),
        ...
        strip.text.x=element_text(size=12),
        axis.text.x=element_text(angle=90))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.50, fill=OstCluster0.50)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
...
#umi counts
ggplot(data@meta.data, aes(x=OstCluster0.50, y=nCount_RNA, fill=OstCluster0.50)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  ...
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.50, y=nCount_RNA, fill=OstCluster0.50)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
...
#gene counts
ggplot(data@meta.data, aes(x=OstCluster0.50, y=nFeature_RNA, fill=OstCluster0.50)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
  ...
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.50, y=nFeature_RNA, fill=OstCluster0.50)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99","dodgerblue","deepskyblue2","dodgerblue4","navyblue")) +
  facet_grid(~Species)+
...
DotPlot(subset(data,subset=Species=="Chimp"),
        ...
        cols=c("grey99","black"),
        col.max=5)
DotPlot(subset(data,subset=Species=="Human" & data@meta.data$OstCluster0.50!="not osteogenic"),
        features=c("MEPE","PHEX","BGLAP","RUNX2"),
        group.by="OstCluster0.50",
        dot.scale=20,
        cols=c("grey99","dodgerblue"),
        col.max=5)
DotPlot(subset(data,subset=Species=="Chimp" & data@meta.data$OstCluster0.50!="not osteogenic"),
        features=c("MEPE","PHEX","BGLAP","RUNX2"),
        group.by="OstCluster0.50",
        dot.scale=20,
        cols=c("grey99","dodgerblue"),
...
#cell counts
ggplot(data@meta.data, aes(x=OstCluster0.75, fill=OstCluster0.75)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99",
                                      "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
                                      "lightblue1","royalblue3","grey","black")) +
  facet_grid(~Species)+
  theme_classic() +
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.75, fill=OstCluster0.75)) +
  geom_bar(position="dodge") +
  labs(y="Number of Cells", x="") +
  scale_fill_manual(name="", values=c("grey99",
                                      "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
...
#umi counts
ggplot(data@meta.data, aes(x=OstCluster0.75, y=nCount_RNA, fill=OstCluster0.75)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99",
                                      "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
  ...
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.75, y=nCount_RNA, fill=OstCluster0.75)) +
  geom_violin(width=0.8) +
  labs(y="UMIs per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99",
                                      "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
...
#gene counts
ggplot(data@meta.data, aes(x=OstCluster0.75, y=nFeature_RNA, fill=OstCluster0.75)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99",
                                      "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
  ...
  theme(axis.text=element_text(size=12),
        ...
        legend.text=element_text(size=12),
        strip.text.x=element_text(size=12))
ggplot(data@meta.data[which(data@meta.data$Stage=="Time 2"),], aes(x=OstCluster0.75, y=nFeature_RNA, fill=OstCluster0.75)) +
  geom_violin(width=0.8) +
  labs(y="Genes per Cell", x="") +
  scale_fill_manual(name="", values=c("grey99",
                                      "dodgerblue","dodgerblue4","deepskyblue2","navyblue",
...
#resolution=0.75
genes <- readRDS("./output/markers0.75.data.filterC.log.indv-cell.intNo0.reg-tot.rds")

#resolution=0.75-iPSC.c1
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==1)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c1) Genes")

#resolution=0.75-iPSC.c2
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==3)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c2) Genes")

#resolution=0.75-iPSC.c3
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==7)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c3) Genes")

#resolution=0.75-iPSC.c4
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==13)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c4) Genes")

#resolution=0.75-iPSC.c5
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==15)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c5) Genes")

#resolution=0.75-iPSC.c6
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==11)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c6) Genes")

#resolution=0.75-iPSC.c7
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==14)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c7) Genes")

#resolution=0.75-iPSC.c8
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==18)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(iPSC.c8) Genes")

#resolution=0.75-MSC.c1
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==0)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(MSC.c1) Genes")

#resolution=0.75-MSC.c2
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==4)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(MSC.c2) Genes")

#resolution=0.75-MSC.c3
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==2)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(MSC.c3) Genes")

#resolution=0.75-MSC.c4
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==9)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(MSC.c4) Genes")

#resolution=0.75-Osteogenic.c1
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==5)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c1) Genes")

#resolution=0.75-Osteogenic.c2
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==8)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c2) Genes")

#resolution=0.75-Osteogenic.c3
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==10)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c3) Genes")

#resolution=0.75-Osteogenic.c4
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==6)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c4) Genes")

#resolution=0.75-Osteogenic.c5
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==12)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c5) Genes")

#resolution=0.75-Osteogenic.c6
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==16)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c6) Genes")

#resolution=0.75-Osteogenic.c7
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==17)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c7) Genes")

#resolution=0.75-Osteogenic.c8
geneSub <- genes %>% group_by(cluster) %>% top_n(n=100, wt=avg_logFC) %>% filter(cluster==19)
goTot <- goEnrich(totGenes=geneTot, deGenes=geneSub$gene, ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Cluster0.75(Osteogenic.c8) Genes")
...
cell.subset <- c("iPSC.c1","iPSC.c2","iPSC.c3","iPSC.c4","iPSC.c5","iPSC.c6","iPSC.c7","iPSC.c8",
                 "MSC.c1","MSC.c2","MSC.c3","MSC.c4",
                 "Osteogenic.c1","Osteogenic.c2","Osteogenic.c3","Osteogenic.c4","Osteogenic.c5","Osteogenic.c6","Osteogenic.c7","Osteogenic.c8")
counts <- c()
metadata <- c()
labels <- c()
for(j in cell.subset) {
  dataSub <- subset(data,subset=Cluster0.75==j)
  for (i in unique(dataSub@meta.data$Individual.Replicate)) {
    x.lab <- paste0(i,"_",j)
    w <- which(dataSub@meta.data$Individual.Replicate==i)
    if (length(w)>0) {
      ...
      x.rep <- dataSub@meta.data$Replicate[w][1]
      x.idr <- dataSub@meta.data$Individual.Replicate[w][1]
      x.clt <- dataSub@meta.data$Cluster0.75[w][1]
      if (length(w)==1) {
        x.cnt <- dataSub@assays$RNA@counts[,w]
      } else {
        x.cnt <- Matrix::rowSums(dataSub@assays$RNA@counts[,w])
...
avg <- data.frame("iPSC.c1"=rowMeans(tmm[,1:14]),
                  ...
                  "iPSC.c3"=rowMeans(tmm[,29:42]),
                  "iPSC.c4"=rowMeans(tmm[,43:56]),
                  "iPSC.c5"=rowMeans(tmm[,57:69]),
                  "iPSC.c6"=rowMeans(tmm[,70:83]),
                  "iPSC.c7"=rowMeans(tmm[,84:97]),
                  "iPSC.c8"=rowMeans(tmm[,98:108]),
                  "MSC.c1"=rowMeans(tmm[,109:122]),
                  "MSC.c2"=rowMeans(tmm[,123:136]),
                  "MSC.c3"=rowMeans(tmm[,137:150]),
                  "MSC.c4"=rowMeans(tmm[,151:163]),
                  "Osteogenic.c1"=rowMeans(tmm[,164:177]),
                  "Osteogenic.c2"=rowMeans(tmm[,178:191]),
                  "Osteogenic.c3"=rowMeans(tmm[,192:205]),
                  "Osteogenic.c4"=rowMeans(tmm[,206:219]),
                  "Osteogenic.c5"=rowMeans(tmm[,220:233]),
                  "Osteogenic.c6"=rowMeans(tmm[,234:240]),
                  "Osteogenic.c7"=rowMeans(tmm[,241:254]),
                  "Osteogenic.c8"=rowMeans(tmm[,255:268]),
                  row.names=rownames(tmm))
...
avg <- data.frame("iPSC.c1"=rowMeans(tmm[,1:7]),
                  ...
                  "iPSC.c3"=rowMeans(tmm[,29:35]),
                  "iPSC.c4"=rowMeans(tmm[,43:49]),
                  "iPSC.c5"=rowMeans(tmm[,57:62]),
                  "iPSC.c6"=rowMeans(tmm[,70:76]),
                  "iPSC.c7"=rowMeans(tmm[,84:90]),
                  "iPSC.c8"=rowMeans(tmm[,98:102]),
                  "MSC.c1"=rowMeans(tmm[,109:115]),
                  "MSC.c2"=rowMeans(tmm[,123:129]),
                  "MSC.c3"=rowMeans(tmm[,137:143]),
                  "MSC.c4"=rowMeans(tmm[,151:156]),
                  "Osteogenic.c1"=rowMeans(tmm[,164:170]),
                  "Osteogenic.c2"=rowMeans(tmm[,178:184]),
                  "Osteogenic.c3"=rowMeans(tmm[,192:198]),
                  "Osteogenic.c4"=rowMeans(tmm[,206:212]),
                  "Osteogenic.c5"=rowMeans(tmm[,220:226]),
                  "Osteogenic.c6"=rowMeans(tmm[,234:235]),
                  "Osteogenic.c7"=rowMeans(tmm[,241:247]),
                  "Osteogenic.c8"=rowMeans(tmm[,255:261]),
                  row.names=rownames(tmm))
...
avg <- data.frame("iPSC.c1"=rowMeans(tmm[,8:14]),
                  ...
                  "iPSC.c3"=rowMeans(tmm[,36:42]),
                  "iPSC.c4"=rowMeans(tmm[,50:56]),
                  "iPSC.c5"=rowMeans(tmm[,63:69]),
                  "iPSC.c6"=rowMeans(tmm[,77:83]),
                  "iPSC.c7"=rowMeans(tmm[,91:97]),
                  "iPSC.c8"=rowMeans(tmm[,103:108]),
                  "MSC.c1"=rowMeans(tmm[,116:122]),
                  "MSC.c2"=rowMeans(tmm[,130:136]),
                  "MSC.c3"=rowMeans(tmm[,144:150]),
                  "MSC.c4"=rowMeans(tmm[,157:163]),
                  "Osteogenic.c1"=rowMeans(tmm[,171:177]),
                  "Osteogenic.c2"=rowMeans(tmm[,185:191]),
                  "Osteogenic.c3"=rowMeans(tmm[,199:205]),
                  "Osteogenic.c4"=rowMeans(tmm[,213:219]),
                  "Osteogenic.c5"=rowMeans(tmm[,227:233]),
                  "Osteogenic.c6"=rowMeans(tmm[,236:240]),
                  "Osteogenic.c7"=rowMeans(tmm[,248:254]),
                  "Osteogenic.c8"=rowMeans(tmm[,262:268]),
                  row.names=rownames(tmm))
...
i1 <- subset(data, subset=(Cluster0.75=="iPSC.c1"))
Idents(i1) <- "i1"
avg.i1 <- log1p(AverageExpression(i1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i1$gene <- rownames(avg.i1)

i2 <- subset(data, subset=(Cluster0.75=="iPSC.c2"))
Idents(i2) <- "i2"
avg.i2 <- log1p(AverageExpression(i2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i2$gene <- rownames(avg.i2)

i3 <- subset(data, subset=(Cluster0.75=="iPSC.c3"))
Idents(i3) <- "i3"
avg.i3 <- log1p(AverageExpression(i3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i3$gene <- rownames(avg.i3)

i4 <- subset(data, subset=(Cluster0.75=="iPSC.c4"))
Idents(i4) <- "i4"
avg.i4 <- log1p(AverageExpression(i4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i4$gene <- rownames(avg.i4)

i5 <- subset(data, subset=(Cluster0.75=="iPSC.c5"))
Idents(i5) <- "i5"
avg.i5 <- log1p(AverageExpression(i5, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i5$gene <- rownames(avg.i5)

i6 <- subset(data, subset=(Cluster0.75=="iPSC.c6"))
Idents(i6) <- "i6"
avg.i6 <- log1p(AverageExpression(i6, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i6$gene <- rownames(avg.i6)

i7 <- subset(data, subset=(Cluster0.75=="iPSC.c7"))
Idents(i7) <- "i7"
avg.i7 <- log1p(AverageExpression(i7, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i7$gene <- rownames(avg.i7)

i8 <- subset(data, subset=(Cluster0.75=="iPSC.c8"))
Idents(i8) <- "i8"
avg.i8 <- log1p(AverageExpression(i8, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i8$gene <- rownames(avg.i8)

m1 <- subset(data, subset=(Cluster0.75=="MSC.c1"))
Idents(m1) <- "m1"
avg.m1 <- log1p(AverageExpression(m1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m1$gene <- rownames(avg.m1)

m2 <- subset(data, subset=(Cluster0.75=="MSC.c2"))
Idents(m2) <- "m2"
avg.m2 <- log1p(AverageExpression(m2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m2$gene <- rownames(avg.m2)

m3 <- subset(data, subset=(Cluster0.75=="MSC.c3"))
Idents(m3) <- "m3"
avg.m3 <- log1p(AverageExpression(m3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m3$gene <- rownames(avg.m3)

m4 <- subset(data, subset=(Cluster0.75=="MSC.c4"))
Idents(m4) <- "m4"
avg.m4 <- log1p(AverageExpression(m4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m4$gene <- rownames(avg.m4)

o1 <- subset(data, subset=(Cluster0.75=="Osteogenic.c1"))
Idents(o1) <- "o1"
avg.o1 <- log1p(AverageExpression(o1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o1$gene <- rownames(avg.o1)

o2 <- subset(data, subset=(Cluster0.75=="Osteogenic.c2"))
Idents(o2) <- "o2"
avg.o2 <- log1p(AverageExpression(o2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o2$gene <- rownames(avg.o2)

o3 <- subset(data, subset=(Cluster0.75=="Osteogenic.c3"))
Idents(o3) <- "o3"
avg.o3 <- log1p(AverageExpression(o3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o3$gene <- rownames(avg.o3)

o4 <- subset(data, subset=(Cluster0.75=="Osteogenic.c4"))
Idents(o4) <- "o4"
avg.o4 <- log1p(AverageExpression(o4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o4$gene <- rownames(avg.o4)

o5 <- subset(data, subset=(Cluster0.75=="Osteogenic.c5"))
Idents(o5) <- "o5"
avg.o5 <- log1p(AverageExpression(o5, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o5$gene <- rownames(avg.o5)

o6 <- subset(data, subset=(Cluster0.75=="Osteogenic.c6"))
Idents(o6) <- "o6"
avg.o6 <- log1p(AverageExpression(o6, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o6$gene <- rownames(avg.o6)

o7 <- subset(data, subset=(Cluster0.75=="Osteogenic.c7"))
Idents(o7) <- "o7"
avg.o7 <- log1p(AverageExpression(o7, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o7$gene <- rownames(avg.o7)

o8 <- subset(data, subset=(Cluster0.75=="Osteogenic.c8"))
Idents(o8) <- "o8"
avg.o8 <- log1p(AverageExpression(o8, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o8$gene <- rownames(avg.o8)
...
rm(i1,i2,i3,i4,i5,i6,i7,i8,m1,m2,m3,m4,o1,o2,o3,o4,o5,o6,o7,o8)
rm(avg.i1,avg.i2,avg.i3,avg.i4,avg.i5,avg.i6,avg.i7,avg.i8,avg.m1,avg.m2,avg.m3,avg.m4,avg.o1,avg.o2,avg.o3,avg.o4,avg.o5,avg.o6,avg.o7,avg.o8)
rm(avg)
...
i1 <- subset(data, subset=(Cluster0.75=="iPSC.c1" & Species=="Human"))
Idents(i1) <- "i1"
avg.i1 <- log1p(AverageExpression(i1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i1$gene <- rownames(avg.i1)

i2 <- subset(data, subset=(Cluster0.75=="iPSC.c2" & Species=="Human"))
Idents(i2) <- "i2"
avg.i2 <- log1p(AverageExpression(i2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i2$gene <- rownames(avg.i2)

i3 <- subset(data, subset=(Cluster0.75=="iPSC.c3" & Species=="Human"))
Idents(i3) <- "i3"
avg.i3 <- log1p(AverageExpression(i3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i3$gene <- rownames(avg.i3)

i4 <- subset(data, subset=(Cluster0.75=="iPSC.c4" & Species=="Human"))
Idents(i4) <- "i4"
avg.i4 <- log1p(AverageExpression(i4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i4$gene <- rownames(avg.i4)

i5 <- subset(data, subset=(Cluster0.75=="iPSC.c5" & Species=="Human"))
Idents(i5) <- "i5"
avg.i5 <- log1p(AverageExpression(i5, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i5$gene <- rownames(avg.i5)

i6 <- subset(data, subset=(Cluster0.75=="iPSC.c6" & Species=="Human"))
Idents(i6) <- "i6"
avg.i6 <- log1p(AverageExpression(i6, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i6$gene <- rownames(avg.i6)

i7 <- subset(data, subset=(Cluster0.75=="iPSC.c7" & Species=="Human"))
Idents(i7) <- "i7"
avg.i7 <- log1p(AverageExpression(i7, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i7$gene <- rownames(avg.i7)

i8 <- subset(data, subset=(Cluster0.75=="iPSC.c8" & Species=="Human"))
Idents(i8) <- "i8"
avg.i8 <- log1p(AverageExpression(i8, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i8$gene <- rownames(avg.i8)

m1 <- subset(data, subset=(Cluster0.75=="MSC.c1" & Species=="Human"))
Idents(m1) <- "m1"
avg.m1 <- log1p(AverageExpression(m1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m1$gene <- rownames(avg.m1)

m2 <- subset(data, subset=(Cluster0.75=="MSC.c2" & Species=="Human"))
Idents(m2) <- "m2"
avg.m2 <- log1p(AverageExpression(m2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m2$gene <- rownames(avg.m2)

m3 <- subset(data, subset=(Cluster0.75=="MSC.c3" & Species=="Human"))
Idents(m3) <- "m3"
avg.m3 <- log1p(AverageExpression(m3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m3$gene <- rownames(avg.m3)

m4 <- subset(data, subset=(Cluster0.75=="MSC.c4" & Species=="Human"))
Idents(m4) <- "m4"
avg.m4 <- log1p(AverageExpression(m4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m4$gene <- rownames(avg.m4)

o1 <- subset(data, subset=(Cluster0.75=="Osteogenic.c1" & Species=="Human"))
Idents(o1) <- "o1"
avg.o1 <- log1p(AverageExpression(o1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o1$gene <- rownames(avg.o1)

o2 <- subset(data, subset=(Cluster0.75=="Osteogenic.c2" & Species=="Human"))
Idents(o2) <- "o2"
avg.o2 <- log1p(AverageExpression(o2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o2$gene <- rownames(avg.o2)

o3 <- subset(data, subset=(Cluster0.75=="Osteogenic.c3" & Species=="Human"))
Idents(o3) <- "o3"
avg.o3 <- log1p(AverageExpression(o3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o3$gene <- rownames(avg.o3)

o4 <- subset(data, subset=(Cluster0.75=="Osteogenic.c4" & Species=="Human"))
Idents(o4) <- "o4"
avg.o4 <- log1p(AverageExpression(o4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o4$gene <- rownames(avg.o4)

o5 <- subset(data, subset=(Cluster0.75=="Osteogenic.c5" & Species=="Human"))
Idents(o5) <- "o5"
avg.o5 <- log1p(AverageExpression(o5, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o5$gene <- rownames(avg.o5)

o6 <- subset(data, subset=(Cluster0.75=="Osteogenic.c6" & Species=="Human"))
Idents(o6) <- "o6"
avg.o6 <- log1p(AverageExpression(o6, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o6$gene <- rownames(avg.o6)

o7 <- subset(data, subset=(Cluster0.75=="Osteogenic.c7" & Species=="Human"))
Idents(o7) <- "o7"
avg.o7 <- log1p(AverageExpression(o7, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o7$gene <- rownames(avg.o7)

o8 <- subset(data, subset=(Cluster0.75=="Osteogenic.c8" & Species=="Human"))
Idents(o8) <- "o8"
avg.o8 <- log1p(AverageExpression(o8, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o8$gene <- rownames(avg.o8)
...
i1 <- subset(data, subset=(Cluster0.75=="iPSC.c1" & Species=="Chimp"))
Idents(i1) <- "i1"
avg.i1 <- log1p(AverageExpression(i1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i1$gene <- rownames(avg.i1)

i2 <- subset(data, subset=(Cluster0.75=="iPSC.c2" & Species=="Chimp"))
Idents(i2) <- "i2"
avg.i2 <- log1p(AverageExpression(i2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i2$gene <- rownames(avg.i2)

i3 <- subset(data, subset=(Cluster0.75=="iPSC.c3" & Species=="Chimp"))
Idents(i3) <- "i3"
avg.i3 <- log1p(AverageExpression(i3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i3$gene <- rownames(avg.i3)

i4 <- subset(data, subset=(Cluster0.75=="iPSC.c4" & Species=="Chimp"))
Idents(i4) <- "i4"
avg.i4 <- log1p(AverageExpression(i4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i4$gene <- rownames(avg.i4)

i5 <- subset(data, subset=(Cluster0.75=="iPSC.c5" & Species=="Chimp"))
Idents(i5) <- "i5"
avg.i5 <- log1p(AverageExpression(i5, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i5$gene <- rownames(avg.i5)

i6 <- subset(data, subset=(Cluster0.75=="iPSC.c6" & Species=="Chimp"))
Idents(i6) <- "i6"
avg.i6 <- log1p(AverageExpression(i6, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i6$gene <- rownames(avg.i6)

i7 <- subset(data, subset=(Cluster0.75=="iPSC.c7" & Species=="Chimp"))
Idents(i7) <- "i7"
avg.i7 <- log1p(AverageExpression(i7, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i7$gene <- rownames(avg.i7)

i8 <- subset(data, subset=(Cluster0.75=="iPSC.c8" & Species=="Chimp"))
Idents(i8) <- "i8"
avg.i8 <- log1p(AverageExpression(i8, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.i8$gene <- rownames(avg.i8)

m1 <- subset(data, subset=(Cluster0.75=="MSC.c1" & Species=="Chimp"))
Idents(m1) <- "m1"
avg.m1 <- log1p(AverageExpression(m1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m1$gene <- rownames(avg.m1)

m2 <- subset(data, subset=(Cluster0.75=="MSC.c2" & Species=="Chimp"))
Idents(m2) <- "m2"
avg.m2 <- log1p(AverageExpression(m2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m2$gene <- rownames(avg.m2)

m3 <- subset(data, subset=(Cluster0.75=="MSC.c3" & Species=="Chimp"))
Idents(m3) <- "m3"
avg.m3 <- log1p(AverageExpression(m3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m3$gene <- rownames(avg.m3)

m4 <- subset(data, subset=(Cluster0.75=="MSC.c4" & Species=="Chimp"))
Idents(m4) <- "m4"
avg.m4 <- log1p(AverageExpression(m4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.m4$gene <- rownames(avg.m4)

o1 <- subset(data, subset=(Cluster0.75=="Osteogenic.c1" & Species=="Chimp"))
Idents(o1) <- "o1"
avg.o1 <- log1p(AverageExpression(o1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o1$gene <- rownames(avg.o1)

o2 <- subset(data, subset=(Cluster0.75=="Osteogenic.c2" & Species=="Chimp"))
Idents(o2) <- "o2"
avg.o2 <- log1p(AverageExpression(o2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o2$gene <- rownames(avg.o2)

o3 <- subset(data, subset=(Cluster0.75=="Osteogenic.c3" & Species=="Chimp"))
Idents(o3) <- "o3"
avg.o3 <- log1p(AverageExpression(o3, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o3$gene <- rownames(avg.o3)

o4 <- subset(data, subset=(Cluster0.75=="Osteogenic.c4" & Species=="Chimp"))
Idents(o4) <- "o4"
avg.o4 <- log1p(AverageExpression(o4, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o4$gene <- rownames(avg.o4)

o5 <- subset(data, subset=(Cluster0.75=="Osteogenic.c5" & Species=="Chimp"))
Idents(o5) <- "o5"
avg.o5 <- log1p(AverageExpression(o5, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o5$gene <- rownames(avg.o5)

o6 <- subset(data, subset=(Cluster0.75=="Osteogenic.c6" & Species=="Chimp"))
Idents(o6) <- "o6"
avg.o6 <- log1p(AverageExpression(o6, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o6$gene <- rownames(avg.o6)

o7 <- subset(data, subset=(Cluster0.75=="Osteogenic.c7" & Species=="Chimp"))
Idents(o7) <- "o7"
avg.o7 <- log1p(AverageExpression(o7, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o7$gene <- rownames(avg.o7)

o8 <- subset(data, subset=(Cluster0.75=="Osteogenic.c8" & Species=="Chimp"))
Idents(o8) <- "o8"
avg.o8 <- log1p(AverageExpression(o8, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.o8$gene <- rownames(avg.o8)
...
### Enrichment
Assess GO functional enrichment of genes defining each ad hoc classification.

```{r, eval=FALSE}

#Find markers for each stage of differentiation
markers.i <- FindMarkers(data, ident.1="iPSC", group.by="AdHoc.Assign.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)       #ipsc
markers.m <- FindMarkers(data, ident.1="MSC", group.by="AdHoc.Assign.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)        #msc
markers.o <- FindMarkers(data, ident.1="Osteogenic", group.by="AdHoc.Assign.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25) #osteo
markers.x <- FindMarkers(data, ident.1="other", group.by="AdHoc.Assign.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)      #other
saveRDS(markers.i, file="./output/markersAdHoc-I.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.m, file="./output/markersAdHoc-M.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.o, file="./output/markersAdHoc-O.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.x, file="./output/markersAdHoc-X.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
...
#AdHoc-iPSC
genes <- readRDS("./output/markersAdHoc-I.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ad Hoc iPSC Genes")

#AdHoc-MSC
genes <- readRDS("./output/markersAdHoc-M.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ad Hoc MSC Genes")

#AdHoc-Osteogenic
genes <- readRDS("./output/markersAdHoc-O.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ad Hoc Osteogenic Genes")

#AdHoc-other
genes <- readRDS("./output/markersAdHoc-X.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ad Hoc other Genes")
...
DotPlot(subset(data,subset=Species=="Chimp"),
        ...
        cols=c("grey99","black"),
        col.max=5)
DotPlot(subset(data,subset=Species=="Human" & data@meta.data$OstAdHoc.Assign.4gene.thresh0!="not osteogenic"),
        features=c("MEPE","PHEX","BGLAP","RUNX2"),
        group.by="OstAdHoc.Assign.4gene.thresh0",
        dot.scale=20,
        cols=c("grey99","dodgerblue"),
        col.max=5)
DotPlot(subset(data,subset=Species=="Chimp" & data@meta.data$OstAdHoc.Assign.4gene.thresh0!="not osteogenic"),
        features=c("MEPE","PHEX","BGLAP","RUNX2"),
        group.by="OstAdHoc.Assign.4gene.thresh0",
        dot.scale=20,
        cols=c("grey99","dodgerblue"),
...
### Enrichment
Assess GO functional enrichment of genes defining each ad hoc classification (only 4 genes and 4 genes.x).
...
#Find markers for each stage of differentiation
markers.pre <- FindMarkers(data, ident.1="preosteoblast", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)          #pre
markers.obl <- FindMarkers(data, ident.1="osteoblast", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)             #obl
markers.emb <- FindMarkers(data, ident.1="embedding osteoblast", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)   #emb
markers.min <- FindMarkers(data, ident.1="mineralizing osteoblast", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)#min
markers.mat <- FindMarkers(data, ident.1="maturing osteocyte", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)     #mat
markers.ukn <- FindMarkers(data, ident.1="unknown osteogenic", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)     #ukn
markers.nan <- FindMarkers(data, ident.1="not osteogenic", group.by="OstAdHoc.Assign.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)         #nan
saveRDS(markers.pre, file="./output/markersOstAdHoc-pre.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.obl, file="./output/markersOstAdHoc-obl.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.emb, file="./output/markersOstAdHoc-emb.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.min, file="./output/markersOstAdHoc-min.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.mat, file="./output/markersOstAdHoc-mat.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.ukn, file="./output/markersOstAdHoc-ukn.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.nan, file="./output/markersOstAdHoc-nan.data.filterC.log.indv-cell.intNo0.reg-tot.rds")

```

```{r}

#OstAdHoc-preosteoblast
genes <- readRDS("./output/markersOstAdHoc-pre.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc Pre Genes")

#OstAdHoc-osteoblast
genes <- readRDS("./output/markersOstAdHoc-obl.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc Obl Genes")

#OstAdHoc-embedding osteoblast
genes <- readRDS("./output/markersOstAdHoc-emb.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc Emb Genes")

#OstAdHoc-mineralizing osteoblast
genes <- readRDS("./output/markersOstAdHoc-min.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc Min Genes")

#OstAdHoc-maturing osteoblast
genes <- readRDS("./output/markersOstAdHoc-mat.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc Mat Genes")

#OstAdHoc-unknown osteogenic
genes <- readRDS("./output/markersOstAdHoc-ukn.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc Ukn Genes")

#OstAdHoc-not osteogenic
genes <- readRDS("./output/markersOstAdHoc-nan.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
goTot@result$Description <- str_wrap(goTot@result$Description, width=30)
goEnPlot(goTot,title="Ost Ad Hoc NaN Genes")
...
#Find markers for each stage of differentiation
markers.pre <- FindMarkers(data, ident.1="preosteoblast", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)          #pre
markers.obl <- FindMarkers(data, ident.1="osteoblast", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)             #obl
markers.emb <- FindMarkers(data, ident.1="embedding osteoblast", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)   #emb
markers.min <- FindMarkers(data, ident.1="mineralizing osteoblast", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)#min
markers.mat <- FindMarkers(data, ident.1="maturing osteocyte", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)     #mat
markers.ukn <- FindMarkers(data, ident.1="unknown osteogenic", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)     #ukn
markers.nan <- FindMarkers(data, ident.1="not osteogenic", group.by="OstAdHoc.Assign.x.4gene.thresh0", only.pos=TRUE, min.pct=0.25, logfc.threshold=0.25)         #nan
saveRDS(markers.pre, file="./output/markersOstAdHocX-pre.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.obl, file="./output/markersOstAdHocX-obl.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.emb, file="./output/markersOstAdHocX-emb.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.min, file="./output/markersOstAdHocX-min.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.mat, file="./output/markersOstAdHocX-mat.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.ukn, file="./output/markersOstAdHocX-ukn.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
saveRDS(markers.nan, file="./output/markersOstAdHocX-nan.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
...
#OstAdHoc-preosteoblast
genes <- readRDS("./output/markersOstAdHocX-pre.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
#OstAdHoc-osteoblast
genes <- readRDS("./output/markersOstAdHocX-obl.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
#OstAdHoc-embedding osteoblast
genes <- readRDS("./output/markersOstAdHocX-emb.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
#OstAdHoc-mineralizing osteoblast
genes <- readRDS("./output/markersOstAdHocX-min.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
#OstAdHoc-maturing osteoblast
genes <- readRDS("./output/markersOstAdHocX-mat.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
#OstAdHoc-unknown osteogenic
genes <- readRDS("./output/markersOstAdHocX-ukn.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
#OstAdHoc-not osteogenic
genes <- readRDS("./output/markersOstAdHocX-nan.data.filterC.log.indv-cell.intNo0.reg-tot.rds")
#Find top 100 markers, report only the positive ones
geneSub <- genes %>% top_n(n=100, wt=avg_logFC)
#Test for functional enrichment
goTot <- goEnrich(totGenes=geneTot, deGenes=rownames(geneSub), ontology="ALL")
...
cellassign <- data@meta.data[,c("Stage",
                                "Cluster0.05",
                                "Cluster0.25",
                                "Cluster0.50",
                                "Cluster0.75",
...
cellassign["Cell"] <- rownames(cellassign)
...
conf_mat <- confusion_matrix(targets=cellassign$Stage,
                             predictions=cellassign$Cluster0.05)

conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$Stage) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$Cluster0.05)),]

plot_confusion_matrix(conf_mat_edit,
                      add_counts=TRUE,
...
rm(conf_mat,conf_mat_edit)

```

### Stage vs. General Ad Hoc

```{r}

conf_mat <- confusion_matrix(targets=cellassign$Stage,
                             predictions=cellassign$AdHoc.Assign.thresh0)

conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$Stage) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$AdHoc.Assign.thresh0)),]
...
### Cluster vs. General Ad Hoc

```{r}

conf_mat <- confusion_matrix(targets=cellassign$Cluster0.05,
                             predictions=cellassign$AdHoc.Assign.thresh0)

conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$Cluster0.05) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$AdHoc.Assign.thresh0)),]
...
### Stage vs. Osteogenic Cluster (res=0.50)

```{r}

conf_mat <- confusion_matrix(targets=cellassign$Stage,
                             predictions=cellassign$OstCluster0.50)

conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$Stage) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$OstCluster0.505)),]
...
### Stage vs. Osteogenic Ad Hoc (4 gene flexible)

```{r}

conf_mat <- confusion_matrix(targets=cellassign$OstAdHoc.Assign.4gene.thresh0,
                             predictions=cellassign$Stage)

conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$OstAdHoc.Assign.4gene.thresh0) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$Stage)),]
...
### Stage vs. Osteogenic Ad Hoc (4 gene strict)

```{r}

conf_mat <- confusion_matrix(targets=cellassign$OstAdHoc.Assign.x.4gene.thresh0,
                             predictions=cellassign$Stage)

conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$OstAdHoc.Assign.x.4gene.thresh0) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$Stage)),]
...
### Osteogenic Ad Hoc (4 gene flexible) vs Osteogenic Cluster (res=0.50) 
...
conf_mat_edit <- conf_mat$`Confusion Matrix`[[1]][which(conf_mat$`Confusion Matrix`[[1]]$Target %in% unique(cellassign$OstAdHoc.Assign.4gene.thresh0) &
                                                        conf_mat$`Confusion Matrix`[[1]]$Prediction %in% unique(cellassign$OstCluster0.50)),]
...
### Osteogenic Ad Hoc (4 gene strict) vs Osteogenic Cluster (res=0.50) 
