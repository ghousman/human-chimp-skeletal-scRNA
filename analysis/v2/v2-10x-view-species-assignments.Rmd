...
table(spp[spp$Collection.Name=="GHO-1",]$call)  #Chimp=3558, Human=2992, Multiplet= 157
table(spp[spp$Collection.Name=="GHO-2",]$call)  #Chimp=3238, Human=2602, Multiplet= 127
table(spp[spp$Collection.Name=="GHO-4",]$call)  #Chimp=1704, Human=2062, Multiplet= 913
table(spp[spp$Collection.Name=="HOU-10",]$call) #Chimp=3101, Human=3711, Multiplet= 210
table(spp[spp$Collection.Name=="HOU-12",]$call) #Chimp=2612, Human=4063, Multiplet= 161
table(spp[spp$Collection.Name=="HOU-16",]$call) #Chimp=1680, Human=1873, Multiplet= 702
table(spp[spp$Collection.Name=="HOU-1",]$call)  #Chimp=1466, Human=2087, Multiplet= 607
table(spp[spp$Collection.Name=="HOU-2",]$call)  #Chimp=2228, Human=3102, Multiplet=  71
table(spp[spp$Collection.Name=="HOU-4",]$call)  #Chimp=2676, Human=2924, Multiplet= 135
table(spp[spp$Collection.Name=="HOU-9",]$call)  #Chimp=2659, Human=2417, Multiplet= 181
table(spp[spp$Collection.Name=="HOU-11",]$call) #Chimp=2507, Human=2435, Multiplet= 116
table(spp[spp$Collection.Name=="HOU-15",]$call) #Chimp= 611, Human= 404, Multiplet=1197
table(spp[spp$Collection.Name=="HOU-5",]$call)  #Chimp=2489, Human=2083, Multiplet=  87
table(spp[spp$Collection.Name=="HOU-6",]$call)  #Chimp=2891, Human=1308, Multiplet=  91
table(spp[spp$Collection.Name=="HOU-8",]$call)  #Chimp=3017, Human=1001, Multiplet= 811
table(spp[spp$Collection.Name=="HOU-17",]$call) #Chimp=3334, Human=2758, Multiplet= 141
table(spp[spp$Collection.Name=="HOU-19",]$call) #Chimp=4139, Human=2906, Multiplet= 210
table(spp[spp$Collection.Name=="HOU-21",]$call) #Chimp=2070, Human=1245, Multiplet= 673
table(spp[spp$Collection.Name=="HOU-18",]$call) #Chimp=3693, Human=2239, Multiplet= 130
table(spp[spp$Collection.Name=="HOU-20",]$call) #Chimp=1975, Human=2878, Multiplet= 152
table(spp[spp$Collection.Name=="HOU-22",]$call) #Chimp=3195, Human=3994, Multiplet= 171

table(spp$Stage)                      #Time0=40100, Time1=39812, Time2=33058
table(spp[spp$Stage=="Time 0",]$call) #Chimp=20300, Human=18287, Multiplet=1513
table(spp[spp$Stage=="Time 1",]$call) #Chimp=19590, Human=19294, Multiplet= 928
table(spp[spp$Stage=="Time 2",]$call) #Chimp=14953, Human=13503, Multiplet=4602
table(spp$call)                       #Chimp=54843, Human=51084, Multiplet=7043
...
* cells collected at Time 2 (osteoblasts) tend to have lower counts than cells collected at Time 0 (iPSCs) and Time 1 (MSCs)

```{r}

#total number of species assignments per collection
ggplot(spp, aes(x=Collection.Name, fill=call)) +
  geom_bar() +
...
ggplot(subset(spp,call!="Multiplet"), aes(x=Stage, fill=call)) +
  geom_bar(position="fill") +
  labs(title="Alignment to Human Ortho-Exon") +
  theme_classic() +
...
### Conclusion after viewing 10X cellranger species assignments:

* Each 10X collection has ~50% human cells and ~50% chimp cells
...
* Using ortho-exon v2 (as compared to v1) generally results in fewer multiplets, more chimp singlets, and more Time 2 cells
