...
* Performed:
    ...
    + [DE tests using Cormotif](10x-data-6-cormotif-cnts_v2.html) & [Visualized results](10x-plot-cormotif-cnts_v2.html)
    
    + Examined gene set enrichments to determine optimal [FDR](10x-plot-diffexp-thresh.html) & [posterior probability](10x-plot-cormotif-cnts-thresh_v2.html) cutoffs
    
* [Examined variance in gene expression](10x-data-7-variance.html)
...
* [Viewed 10x data subset by stage of differentiation](10x-data-subsets.html)

* [Analyzed technical replicate correlations](10x-plot-replicate-correlations.html)
