---
title: "10x-plot-cormotif-cnts-thresh-v2"
...
cutoffs <- c(0.50, 0.55, 0.60, 0.65, 0.70, 0.75, 0.80, 0.85, 0.90, 0.925, 0.95, 0.975, 0.99)
...
while (x <= length(cutoffs)) {
  ...
  for (genesExternal in listsExternal) {
    ...
    #All to Time 1
    #tempDE <- rownames(dataUpset[[x]])[which(dataUpset[[x]]$Time.1==0)]
    #nonDEgenes <- rownames(dataUpset[[x]])[which(!(rownames(dataUpset[[x]]) %in% tempDE))]
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Time 1",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
    ...
    #All to Time 2
    #tempDE <- rownames(dataUpset[[x]])[which(dataUpset[[x]]$Time.2==0)]
    #nonDEgenes <- rownames(dataUpset[[x]])[which(!(rownames(dataUpset[[x]]) %in% tempDE))]
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Time 2",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
...
while (x <= length(cutoffs)) {
  ...
  for (genesExternal in listsExternal) {
    ...
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Preostoblasts",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
    ...
    #All osteoblasts
    #tempDE <- rownames(dataUpset[[x]])[which(dataUpset[[x]]$osteoblast==1)]
    #nonDEgenes <- rownames(dataUpset[[x]])[which(!(rownames(dataUpset[[x]]) %in% tempDE))]
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Osteoblasts",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
    ...
    #tempDE <- rownames(dataUpset[[x]])[which(dataUpset[[x]]$embedding.osteoblast==1)]
    #nonDEgenes <- rownames(dataUpset[[x]])[which(!(rownames(dataUpset[[x]]) %in% tempDE))]
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Embedding Osteoblasts",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
    ...
    #tempDE <- rownames(dataUpset[[x]])[which(dataUpset[[x]]$mineralizing.osteoblast==1)]
    #nonDEgenes <- rownames(dataUpset[[x]])[which(!(rownames(dataUpset[[x]]) %in% tempDE))]
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Mineralizing Osteoblasts",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
    ...
    #tempDE <- rownames(dataUpset[[x]])[which(dataUpset[[x]]$maturing.osteocyte==1)]
    #nonDEgenes <- rownames(dataUpset[[x]])[which(!(rownames(dataUpset[[x]]) %in% tempDE))]
    #DEenrich <- rbind(DEenrich,
    #                  genesetEnrich.data(InternalDataCutoff=cutoffs[x],
    #                                     InternalDataSource="All Maturing Osteocytes",
    #                                     ExternalDataSource=genesExternal[[1]],
    #                                     GenesOfInterest=genesExternal[[2]],
    #                                     DEgenes=tempDE,
    #                                     NonDEGenes=nonDEgenes))
...
* Stages of Differentiation: 0.55 or 0.65
* Stages of Osteogenesis: 0.65 or 0.75 or 0.80 or 0.85 or 0.925 or 0.95 or 0.975
* Stages of Osteogenesis (Time 2 only): 0.50 or 0.55 or 0.65 or 0.70 or 0.75
* OVERALL: 0.65
