...
```{r qc scRNA data - visual qc metrics, eval=FALSE, echo=TRUE}
...
```{r qc scRNA data - filter barcodes and genes, eval=FALSE, echo=TRUE}
...
```{r qc scRNA data - visual qc metrics after filtering cells: data.filter, eval=FALSE, echo=TRUE}
...
```{r qc scRNA data - visual qc metrics after filtering cells: data.filterMT, eval=FALSE, echo=TRUE}
