...
```{r}
VlnPlot(subset(data,subset=Cluster0.05=="iPSC.c1"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Species")
VlnPlot(subset(data,subset=Cluster0.05=="iPSC.c1"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Individual.Replicate")
```

(all cells from unsupervised iPSC.c2):
```{r}
VlnPlot(subset(data,subset=Cluster0.05=="iPSC.c2"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Species")
VlnPlot(subset(data,subset=Cluster0.05=="iPSC.c2"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Individual.Replicate")
```

(all cells from unsupervised iPSC.c3):
```{r}
VlnPlot(subset(data,subset=Cluster0.05=="iPSC.c3"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Species")
VlnPlot(subset(data,subset=Cluster0.05=="iPSC.c3"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Individual.Replicate")
```

(all cells from ad hoc iPSC assignment):
```{r}
VlnPlot(subset(data,subset=AdHoc.Assign.thresh0=="iPSC"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Species")
VlnPlot(subset(data,subset=AdHoc.Assign.thresh0=="iPSC"), assay="integrated", slot="scale.data", features=c("UTF1","TAC3"), pt.size=0, group.by="Individual.Replicate")
```
...
```{r, eval=FALSE}
rownames(data@meta.data[which(data@meta.data$Cluster0.05=="iPSC.c1" & data@meta.data$Stage=="Time 1"),])
rownames(data@meta.data[which(data@meta.data$Cluster0.05=="iPSC.c1" & data@meta.data$Stage=="Time 2"),])
rownames(data@meta.data[which(data@meta.data$Cluster0.05=="iPSC.c2" & data@meta.data$Stage=="Time 2"),])
```
...
#Cluster-based iPSCs
x <- avg.utf1.tac3(data, data.condition=(data@meta.data$Cluster0.05=="iPSC.c1"|data@meta.data$Cluster0.05=="iPSC.c2"|data@meta.data$Cluster0.05=="iPSC.c3"))
x <- data.frame(t(x))
utf1.tac3 <- cbind(utf1.tac3,x)

x <- avg.utf1.tac3(data, data.condition=data@meta.data$Cluster0.05=="iPSC.c1")
x <- data.frame(t(x))
utf1.tac3 <- cbind(utf1.tac3,x)

x <- avg.utf1.tac3(data, data.condition=data@meta.data$Cluster0.05=="iPSC.c2")
x <- data.frame(t(x))
utf1.tac3 <- cbind(utf1.tac3,x)

x <- avg.utf1.tac3(data, data.condition=data@meta.data$Cluster0.05=="iPSC.c3")
x <- data.frame(t(x))
utf1.tac3 <- cbind(utf1.tac3,x)
...
#Cluster-based MSCs
#condition (a)
utf1.tac3$NumbMTot.Cluster.a <- cell.counts.tot(data, data@meta.data$Cluster0.05)
utf1.tac3$NumbMSC.Cluster.a  <- cell.counts.sub(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="MSC.c1")
utf1.tac3$PropMSC.Cluster.a  <- utf1.tac3$NumbMSC.Cluster.a/utf1.tac3$NumbMTot.Cluster.a
#condition (b)
utf1.tac3$NumbMTot.Cluster.b <- cell.counts.tot.m(data, data@meta.data$Cluster0.05)
utf1.tac3$NumbMSC.Cluster.b  <- cell.counts.sub.m(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="MSC.c1")
utf1.tac3$PropMSC.Cluster.b  <- utf1.tac3$NumbMSC.Cluster.b/utf1.tac3$NumbMTot.Cluster.b

#Ad hoc-based MSCs
#condition (a)
utf1.tac3$NumbMTot.AdHoc.a <- cell.counts.tot(data, data@meta.data$AdHoc.Assign.thresh0)
utf1.tac3$NumbMSC.AdHoc.a  <- cell.counts.sub(data, data@meta.data$AdHoc.Assign.thresh0, data@meta.data$AdHoc.Assign.thresh0=="MSC")
utf1.tac3$PropMSC.AdHoc.a  <- utf1.tac3$NumbMSC.AdHoc.a/utf1.tac3$NumbMTot.AdHoc.a
#condition (b)
utf1.tac3$NumbMTot.AdHoc.b <- cell.counts.tot.m(data, data@meta.data$AdHoc.Assign.thresh0)
utf1.tac3$NumbMSC.AdHoc.b  <- cell.counts.sub.m(data, data@meta.data$AdHoc.Assign.thresh0, data@meta.data$AdHoc.Assign.thresh0=="MSC")
...
#condition (a)
utf1.tac3$NumbOTot.Cluster.a <- cell.counts.tot(data, data@meta.data$Cluster0.05)
utf1.tac3$NumbOst.Cluster.a  <- cell.counts.sub(data, data@meta.data$Cluster0.05, data.condition=(data@meta.data$Cluster0.05=="Osteogenic.c1" | data@meta.data$Cluster0.05=="Osteogenic.c2"))
utf1.tac3$NumbOst1.Cluster.a <- cell.counts.sub(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="Osteogenic.c1")
utf1.tac3$NumbOst2.Cluster.a <- cell.counts.sub(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="Osteogenic.c2")
...
#condition (b)
utf1.tac3$NumbOTot.Cluster.b <- cell.counts.tot.m(data, data@meta.data$Cluster0.05)
utf1.tac3$NumbOst.Cluster.b  <- cell.counts.sub.m(data, data@meta.data$Cluster0.05, data.condition=(data@meta.data$Cluster0.05=="Osteogenic.c1" | data@meta.data$Cluster0.05=="Osteogenic.c2"))
utf1.tac3$NumbOst1.Cluster.b <- cell.counts.sub.m(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="Osteogenic.c1")
utf1.tac3$NumbOst2.Cluster.b <- cell.counts.sub.m(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="Osteogenic.c2")
...
#condition (c)
utf1.tac3$NumbOTot.Cluster.c <- cell.counts.tot.o(data, data@meta.data$Cluster0.05)
utf1.tac3$NumbOst.Cluster.c  <- cell.counts.sub.o(data, data@meta.data$Cluster0.05, data.condition=(data@meta.data$Cluster0.05=="Osteogenic.c1" | data@meta.data$Cluster0.05=="Osteogenic.c2"))
utf1.tac3$NumbOst1.Cluster.c <- cell.counts.sub.o(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="Osteogenic.c1")
utf1.tac3$NumbOst2.Cluster.c <- cell.counts.sub.o(data, data@meta.data$Cluster0.05, data@meta.data$Cluster0.05=="Osteogenic.c2")
...
#condition (a)
utf1.tac3$NumbOTot.AdHoc.a <- cell.counts.tot(data, data@meta.data$AdHoc.Assign.thresh0)
utf1.tac3$NumbOst.AdHoc.a  <- cell.counts.sub(data, data@meta.data$AdHoc.Assign.thresh0, data@meta.data$AdHoc.Assign.thresh0=="Osteogenic")
utf1.tac3$PropOst.AdHoc.a  <- utf1.tac3$NumbOst.AdHoc.a/utf1.tac3$NumbOTot.AdHoc.a
#condition (b)
utf1.tac3$NumbOTot.AdHoc.b <- cell.counts.tot.m(data, data@meta.data$AdHoc.Assign.thresh0)
utf1.tac3$NumbOst.AdHoc.b  <- cell.counts.sub.m(data, data@meta.data$AdHoc.Assign.thresh0, data@meta.data$AdHoc.Assign.thresh0=="Osteogenic")
utf1.tac3$PropOst.AdHoc.b  <- utf1.tac3$NumbOst.AdHoc.b/utf1.tac3$NumbOTot.AdHoc.b
#condition (c)
utf1.tac3$NumbOTot.AdHoc.c <- cell.counts.tot.o(data, data@meta.data$AdHoc.Assign.thresh0)
utf1.tac3$NumbOst.AdHoc.c  <- cell.counts.sub.o(data, data@meta.data$AdHoc.Assign.thresh0, data@meta.data$AdHoc.Assign.thresh0=="Osteogenic")
utf1.tac3$PropOst.AdHoc.c  <- utf1.tac3$NumbOst.AdHoc.c/utf1.tac3$NumbOTot.AdHoc.c

#Ost ad hoc-based Osteogenic Cells
#condition (a)
utf1.tac3$NumbOTot.OstAdHoc.a <- cell.counts.tot(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0)
utf1.tac3$NumbPre.OstAdHoc.a  <- cell.counts.sub(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="preosteoblast")
utf1.tac3$NumbObl.OstAdHoc.a  <- cell.counts.sub(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="osteoblast")
utf1.tac3$NumbEmb.OstAdHoc.a  <- cell.counts.sub(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="embedding osteoblast")
utf1.tac3$NumbMin.OstAdHoc.a  <- cell.counts.sub(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="mineralizing osteoblast")
utf1.tac3$NumbMat.OstAdHoc.a  <- cell.counts.sub(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="maturing osteocyte")
...
#condition (b)
utf1.tac3$NumbOTot.OstAdHoc.b <- cell.counts.tot.m(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0)
utf1.tac3$NumbPre.OstAdHoc.b  <- cell.counts.sub.m(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="preosteoblast")
utf1.tac3$NumbObl.OstAdHoc.b  <- cell.counts.sub.m(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="osteoblast")
utf1.tac3$NumbEmb.OstAdHoc.b  <- cell.counts.sub.m(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="embedding osteoblast")
utf1.tac3$NumbMin.OstAdHoc.b  <- cell.counts.sub.m(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="mineralizing osteoblast")
utf1.tac3$NumbMat.OstAdHoc.b  <- cell.counts.sub.m(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="maturing osteocyte")
...
#condition (c)
utf1.tac3$NumbOTot.OstAdHoc.c <- cell.counts.tot.o(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0)
utf1.tac3$NumbPre.OstAdHoc.c  <- cell.counts.sub.o(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="preosteoblast")
utf1.tac3$NumbObl.OstAdHoc.c  <- cell.counts.sub.o(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="osteoblast")
utf1.tac3$NumbEmb.OstAdHoc.c  <- cell.counts.sub.o(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="embedding osteoblast")
utf1.tac3$NumbMin.OstAdHoc.c  <- cell.counts.sub.o(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="mineralizing osteoblast")
utf1.tac3$NumbMat.OstAdHoc.c  <- cell.counts.sub.o(data, data@meta.data$OstAdHoc.Assign.4gene.thresh0, data@meta.data$OstAdHoc.Assign.4gene.thresh0=="maturing osteocyte")
