...
* across general unsupervized clusters (res=0.05): iPSC.c1 ~ iPCS.c2 > iPSC.c3 > MSC.c1 > Osteogenic.c1 ~ Osteogenic.c2
* across general ad hoc assignments: iPSC > MSC > Osteogenic
* across osteogenic unsupervized clusters (res=0.50): Osteogenic.c4 > Osteogenic.c1 > Osteogenic.c3 (cannot assess Osteogenic.c2)
* across osteogenic unsupervized clusters (res=0.75): Osteogenic.c4 > Osteogenic.c5 > Osteogenic.c2 > Osteogenic.c1 > Osteogenic.c3 > Osteogenic.c7 > Osteogenic.c8 (cannot assess Osteogenic.c6)
* across osteogenic ad hoc assignments:
    + 4 genes ( strict ): maturing osteocyte > preosteoblast > mineralizing osteoblast > embedding osteoblast > osteoblast
    + 4 genes (flexible): preosteoblast > embedding osteoblast > osteoblast > maturing osteocyte > mineralizing osteoblast
...
## General unsupervised clustering (res=0.05)
...
## Osteogenic unsupervised clustering (res=0.50)
...
rep1 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9352983
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9805494
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8805291
...
Keep human and chimp samples together.(no H1-r2, C1-r1, or C1-r2 cells are Osteogenic.c2)

```{r, eval=FALSE}

rep1 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)
...
ggplot(rep.avg, aes(rep1, rep2)) +
  geom_point(size=1) +
  geom_smooth(method=lm, se=FALSE, col="deepskyblue2", size=2) +
  labs(x="Average Gene Expression in Replicate 1",y="Average Gene Expression in Replicate 2") +
  theme_classic()
...
Look at humans separately. (no H1-r2, C1-r1, or C1-r2 cells are Osteogenic.c2)

```{r, eval=FALSE}

rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)
...
Look at chimps separately. (no H1-r2, C1-r1, or C1-r2 cells are Osteogenic.c2)

```{r, eval=FALSE}

rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)
...
### Osteogenic.c3 Replicates

Keep human and chimp samples together.

```{r}

rep1 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9293588

ggplot(rep.avg, aes(rep1, rep2)) +
  geom_point(size=1) +
  geom_smooth(method=lm, se=FALSE, col="dodgerblue4", size=2) +
  labs(x="Average Gene Expression in Replicate 1",y="Average Gene Expression in Replicate 2") +
  theme_classic()
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9710619
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8400385
...
### Osteogenic.c4 Replicates

Keep human and chimp samples together.

```{r}

rep1 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.50=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9672193
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.50=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9827074
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.50=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.881707
...
## Osteogenic unsupervised clustering (res=0.75)
...
rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9301917
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9673952
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c1" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8686117
...
rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9361407
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9761505
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c2" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.83729
...
rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8821633
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9768584
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c3" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8724352
...
rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9678718
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.982715
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c4" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8793292
...
### Osteogenic.c5 Replicates

Keep human and chimp samples together.

```{r}

rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c5" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c5" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9575549
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c5" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c5" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.9815715
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c5" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c5" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8760115
...
### Osteogenic.c6 Replicates

Keep human and chimp samples together. (no H1-r1, H1-r2, C1-r1, or C1-r2 cells are Osteogenic.c2)

```{r, eval=FALSE}

rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c6" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c6" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)
...
Look at humans separately. (no H1-r1, H1-r2, C1-r1, or C1-r2 cells are Osteogenic.c2)

```{r, eval=FALSE}

rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c6" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c6" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)
...
Look at chimps separately. (no H1-r1, H1-r2, C1-r1, or C1-r2 cells are Osteogenic.c2)

```{r, eval=FALSE}

rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c6" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c6" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)
...
### Osteogenic.c7 Replicates

Keep human and chimp samples together.

```{r}

rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c7" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c7" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8790707
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c7" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c7" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8099209
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c7" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c7" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.8276301
...
### Osteogenic.c8 Replicates

Keep human and chimp samples together.

```{r}

rep1 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c8" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(OstCluster0.75=="Osteogenic.c8" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.7861775
...
rep1 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c8" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Human" & OstCluster0.75=="Osteogenic.c8" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.7234223
...
rep1 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c8" & Pair=="H1+C1" & Replicate=="1"))
Idents(rep1) <- "rep1"
avg.rep1 <- log1p(AverageExpression(rep1, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep1$gene <- rownames(avg.rep1)

rep2 <- subset(data, subset=(Species=="Chimp" & OstCluster0.75=="Osteogenic.c8" & Pair=="H1+C1" & Replicate=="2"))
Idents(rep2) <- "rep2"
avg.rep2 <- log1p(AverageExpression(rep2, assays="RNA", slot="data", verbose=FALSE)$RNA)
avg.rep2$gene <- rownames(avg.rep2)

rep.avg <- merge(avg.rep1, avg.rep2, by="gene")
cor(rep.avg$rep1, rep.avg$rep2, method="pearson") #pearson correlation = 0.7144325
