---
title: "10x-test-data-ortho-compare"
...
---
---
title: "10x-data-full-cell-type-validation"
author: "Genevieve Housman"
date: "11/12/2019"
output: html_document
editor_options: 
...
## 10X Data Cellranger Comparison (ortho-exon files only)
...
The datasets being evaluated are:
- [h.orth.c.orth.sppo]: comprises gene count data that were seperately processed using both the human genome (h) and the chimpanzee genome (c), as well as the ortho-exon annotation (orth); species-specific assignments were determined using human-chimpanzee genome combination with ortho-exon annotation (sppo).
- [h.orfl.c.orfl.spof]: comprises gene count data that were seperately processed using both the human genome (h) and the chimpanzee genome (c), as well as a filtered version of the ortho-exon annotation (orfl); species-specific assignments were determined using human-chimpanzee genome combination with filtered ortho-exon annotation (spof)

These datasets were choses as compared to other dataset options after comparisons performed in 10x-data-cellranger-compare.Rmd.
...
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Number.of.Reads))+geom_col()+labs(title="h.orth")+ylim(0,300000000)),
                        ...
                        (ggplot(metrics.c.orfl, aes(x=Sample, y=Number.of.Reads))+geom_col()+labs(title="c.orfl")+ylim(0,300000000))), ncol=2)

#percent sequence saturation
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Sequencing.Saturation))+geom_col()+labs(title="h.orth")+ylim(0,1)),
                        ...
                        (ggplot(metrics.c.orfl, aes(x=Sample, y=Sequencing.Saturation))+geom_col()+labs(title="c.orfl")+ylim(0,1))), ncol=2)

#mean reads per cell
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Mean.Reads.per.Cell))+geom_col()+labs(title="h.orth")+ylim(0,85000)),
                        ...
                        (ggplot(metrics.c.orfl, aes(x=Sample, y=Mean.Reads.per.Cell))+geom_col()+labs(title="c.orfl")+ylim(0,85000))), ncol=2)

#median genes per cell
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Median.Genes.per.Cell))+geom_col()+labs(title="h.orth")+ylim(0,4500)),
                        ...
                        (ggplot(metrics.c.orfl, aes(x=Sample, y=Median.Genes.per.Cell))+geom_col()+labs(title="c.orfl")+ylim(0,4500))), ncol=2)

#median UMI per cell
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Median.UMI.Counts.per.Cell))+geom_col()+labs(title="h.orth")+ylim(0,21000)),
                        ...
                        (ggplot(metrics.c.orfl, aes(x=Sample, y=Median.UMI.Counts.per.Cell))+geom_col()+labs(title="c.orfl")+ylim(0,21000))), ncol=2)

#proportion of Q30 bases in barcode, rna read, and umi
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Q30.Bases.in.Barcode))+geom_col()+labs(title="h.orth")+ylim(0,1)),
                        ...
                        (ggplot(metrics.c.orfl, aes(x=Sample, y=Q30.Bases.in.UMI))+geom_col()+labs(title="c.orfl")+ylim(0,1))), ncol=3)

#reads mapped and confidently mapped to genome
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Reads.Mapped.to.Genome))+geom_col()+labs(title="h.orth")+ylim(0,1)),
...
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Reads.Mapped.Confidently.to.Intergenic.Regions))+geom_col()+labs(title="h.orth")+ylim(0,1)),
...
CombinePlots(plots=list((ggplot(metrics.h.orth, aes(x=Sample, y=Fraction.Reads.in.Cells))+geom_col()+labs(title="h.orth")+ylim(0,1)),
...
rm(metrics.h.orth,metrics.c.orth)
rm(metrics.h.orfl,metrics.c.orfl)
...
CombinePlots(plots=list((ggplot(hc.orth.spp1, aes(x=call))+geom_bar()+labs(title="iPSC-orth")+ylim(0,3500)),
                        (ggplot(hc.orth.spp2, aes(x=call))+geom_bar()+labs(title="MSC-orth")+ylim(0,3500)),
                        (ggplot(hc.orth.spp3, aes(x=call))+geom_bar()+labs(title="chondro-orth")+ylim(0,3500)),
                        (ggplot(hc.orth.spp4, aes(x=call))+geom_bar()+labs(title="osteo-orth")+ylim(0,3500)),
                        (ggplot(hc.orfl.spp1, aes(x=call))+geom_bar()+labs(title="iPSC-orfl")+ylim(0,3500)),
                        (ggplot(hc.orfl.spp2, aes(x=call))+geom_bar()+labs(title="MSC-orfl")+ylim(0,3500)),
                        (ggplot(hc.orfl.spp3, aes(x=call))+geom_bar()+labs(title="chondro-orfl")+ylim(0,3500)),
                        (ggplot(hc.orfl.spp4, aes(x=call))+geom_bar()+labs(title="osteo-orfl")+ylim(0,3500))), ncol=4)
...
#(3)view details of seurat objects
  h.orth.GHO1                       #44125 features, 6794880 samples
  h.orth.GHO2                       #44125 features, 6794880 samples
  h.orth.GHO3                       #44125 features, 6794880 samples
  h.orth.GHO4                       #44125 features, 6794880 samples
  c.orth.GHO1                       #44125 features, 6794880 samples
  c.orth.GHO2                       #44125 features, 6794880 samples
  c.orth.GHO3                       #44125 features, 6794880 samples
  c.orth.GHO4                       #44125 features, 6794880 samples
...
#(6)view details of species assignments - sppo
  table(h.orth.GHO1@meta.data$species, useNA="always")   #C=3294, H=2319, M=  87, NA=6789180
  table(h.orth.GHO2@meta.data$species, useNA="always")   #C=3149, H=2563, M= 123, NA=6789045
  table(h.orth.GHO3@meta.data$species, useNA="always")   #C=1305, H=2168, M= 114, NA=6791293
  table(h.orth.GHO4@meta.data$species, useNA="always")   #C=1805, H=1580, M=  62, NA=6791433
  table(c.orth.GHO1@meta.data$species, useNA="always")   #C=3294, H=2319, M=  87, NA=6789180
  table(c.orth.GHO2@meta.data$species, useNA="always")   #C=3149, H=2563, M= 123, NA=6789045
  table(c.orth.GHO3@meta.data$species, useNA="always")   #C=1305, H=2168, M= 114, NA=6791293
  table(c.orth.GHO4@meta.data$species, useNA="always")   #C=1805, H=1580, M=  62, NA=6791433
...
#Prepare data for h.orfl.c.orfl.spof
#(1)load data
...
#(3)view details of seurat objects
  h.orfl.GHO1                       #28942 features, 6794880 samples
  h.orfl.GHO2                       #28942 features, 6794880 samples
  h.orfl.GHO3                       #28942 features, 6794880 samples
  h.orfl.GHO4                       #28942 features, 6794880 samples
  c.orfl.GHO1                       #28942 features, 6794880 samples
  c.orfl.GHO2                       #28942 features, 6794880 samples
  c.orfl.GHO3                       #28942 features, 6794880 samples
  c.orfl.GHO4                       #28942 features, 6794880 samples
#(4)clear raw data from workspace
...
#(6)view details of species assignments - spof
