...
objects.features <- SelectIntegrationFeatures(object.list=objects, nfeatures=6000)
...
#Save data
saveRDS(integrate, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/data.pair.log.6k.int.rds"))
