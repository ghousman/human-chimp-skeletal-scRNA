...
int.ipsc <- ScaleData(int.ipsc, verbose=FALSE, vars.to.regress=c("nCount_RNA","nFeatures"))
...
saveRDS(int.ipsc, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/data.filter.reg.indv-cell.log.int.ipsc.rds"))
...
int.msc <- ScaleData(int.msc, verbose=FALSE, vars.to.regress=c("nCount_RNA","nFeatures"))
...
saveRDS(int.msc, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/data.filter.reg.indv-cell.log.int.msc.rds"))
rm(obj.msc,int.msc)
...
int.osteo <- ScaleData(int.osteo, verbose=FALSE, vars.to.regress=c("nCount_RNA","nFeatures"))
...
saveRDS(int.osteo, file=paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/data.filter.reg.indv-cell.log.int.osteo.rds"))
