...
#Load data
indv <- readRDS(paste0(dir,"/human-chimp-skeletal-scRNA/data/cellranger-data-full/data.filterMT.regMT.indv.log.10k.int.rds")) #integrate across individuals - total
...
for(k in c(3:3)) {
  ...
  tpx.clust <- classtpx::class_topics(
    ...
    method="omega.fix",
    tol=1)
  save(tpx.clust, file=paste0(dir,"human-chimp-skeletal-scRNA/data/cellranger-data-full/gom.sup.",k,".indv.filterMT.regMT.log.10k.int.rds"))
