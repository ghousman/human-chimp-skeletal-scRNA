...
plot.corr.val(validation.data=vData$Alizarin,
              ...
              detail.eff="MSCs (cluster) (b)")
plot.corr.val(validation.data=vData$Alizarin,
              efficiency=utf1.tac3$PropMSC.Cluster.c,
              detail.exp="Alizarin Stain",
              detail.eff="MSCs (cluster) (c)")
...
plot.corr.val(validation.data=vData$Alizarin,
              ...
              detail.eff="MSCs (ad hoc) (b)")
plot.corr.val(validation.data=vData$Alizarin,
              efficiency=utf1.tac3$PropMSC.AdHoc.c,
              detail.exp="Alizarin Stain",
              detail.eff="MSCs (ad hoc) (c)")
...
ggplot(utf1.tac3, aes(x=UTF1.t0, y=PropMSC.Cluster.a, color=Species)) +
  geom_point() +
  geom_smooth(method=lm, se=FALSE)
  theme_classic()

ggplot(utf1.tac3, aes(x=UTF1.t0, y=PropMSC.Cluster.a)) +
  geom_point() +
